/* Register values below were obtained from example code for Raspberry PI
 * provided by Arducam on their GitHub:
...
/* Structure for register address, value pair */
struct sensor_reg {
	uint8_t reg;
	uint8_t val;
};

// image_buffer array used to store an image
uint8_t image_buffer[BUF_SIZE];
...
const struct sensor_reg OV2640_QVGA[]  =
{
	...
	{0x9, 0x2},
	{0x4, 0xa8},
	{0x13, 0xe5},	// auto exposure on
	//{0x13, 0xe4},	// auto exposure off
	{0x14, 0x48},
	{0x2c, 0xc},
	{0x33, 0x78},
	{0x3a, 0x33},
